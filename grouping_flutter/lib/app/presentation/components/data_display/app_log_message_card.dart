...
class LogMessageCard extends StatelessWidget {
  ...
  factory LogMessageCard.fromData(
          {required MessageData messageData, Function? onDelete}) =>
      switch (messageData.type) {
        MessageType.success => LogMessageCard.success(
            title: messageData.title,
            message: messageData.message,
            onDelete: onDelete,
          ),
        MessageType.error => LogMessageCard.error(
            title: messageData.title,
            message: messageData.message,
            onDelete: onDelete,
          ),
        MessageType.warning => LogMessageCard.warning(
            title: messageData.title,
            message: messageData.message,
            onDelete: onDelete,
          ),
        MessageType.info => LogMessageCard(
            message: messageData,
        ...
        MessageType.others => LogMessageCard(
            message: messageData,
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) => Padding(
              ...
              child: LogMessageCard.fromData(
                ...
                onDelete: () => {messageService.clearMessage(messages[index])},
              ),
            ),
          );
        });
