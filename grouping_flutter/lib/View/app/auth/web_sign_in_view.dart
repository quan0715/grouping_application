...
class _WebSignInViewState extends State<WebSignInView> {
  ...
  final inputFieldBorder = const OutlineInputBorder(
      borderRadius: BorderRadius.all(Radius.circular(10)), gapPadding: 10);
            ...
            children: [
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  onChanged: (value) =>
                      signInManager.onPasswordConfirmChange(value),
                ),
              ),
              Padding(
      ...
      child: Column(
        ...
        children: [
          const TitleWithContent(
              title: "註冊 Sign In", content: "加入Grouping，註冊新的Grouping 帳號"),
