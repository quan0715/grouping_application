  ...
  Widget _spaceTagFrame(CreateWorkspaceViewModel vm) {
    return KeyValuePairWidget<String, Widget>(
      ...
      valueChild: Container(
        ...
        child: Padding(
          padding: vm.newWorkspaceData.tags.isEmpty
              ? EdgeInsets.zero
          ...
          child: Column(
            ...
            children: [
              ...
              if (vm.newWorkspaceData.tags.isNotEmpty) const Gap(10),
              Wrap(
        ...
        children: [
          InkWell(
              child: ProfileAvatar(
                  ...
                  avatar: profilePreviewURL.isEmpty
                      ? Icon(Icons.add_a_photo, size: 24, color: vm.spaceColor)
                      : null),
              onTap: () async {
          ...
          Visibility(
            visible:
                vm.newWorkspaceData.photo != null || vm.tempAvatarFile != null,
            child: IconButton(
              onPressed: () {
