...
class WorkspaceInfoFrame extends StatelessWidget
    ...
    return Column(
      ...
      children: [
        ...
        KeyValuePairWidget<String, Widget>(
          ...
          valueChild: Text(workspaceData.currentWorkspace?.name ?? "error",
        ...
        Row(
          children: [
            Wrap(
              ...
              runSpacing: 4.0,
              children: [
                ...workspaceData.currentWorkspace!.tags.map((tag) =>
                    ColorTagChip(
                        color: frameColor, tagString: "# ${tag.content}")),
              ],
            ),
          ],
        ),
        ...
        KeyValuePairWidget<String, Widget>(
            ...
            valueChild: Column(
              children: [
                ...workspaceData.currentWorkspace!.members
                    .map((member) => Padding(
