...
class AuthTokenModel{
  ...
  AuthTokenModel({required String token}): 
    _token = token,
  ...
  _token.isNotEmpty && 
  _jwtTokenModel != null && 
  !_jwtTokenModel!.isExpired;

  factory AuthTokenModel.fromJson(Map<String, dynamic> json)
    => AuthTokenModel(token: json['auth-token']);
...
class JwtTokenModel{
  ...
  JwtTokenModel({required String token}): 
    ...
    _jwtSecreteInformation = JwtSecreteInformation(jwtTokenBody: JwtDecoder.decode(token));
