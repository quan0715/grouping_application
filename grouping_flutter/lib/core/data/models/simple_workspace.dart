...
/// ## [SimpleWorkspace] 為巢狀迴圈資料的 workspace
/// 
/// [SimpleWorkspace] 擁有 workspace 的 [id], [name], [themecolor] 以及他所對應的 [photo] \
...
class SimpleWorkspace {
  ...
  factory SimpleWorkspace.fromJson({required Map<String, dynamic> data}) =>
      SimpleWorkspace(
          id: data["id"],
