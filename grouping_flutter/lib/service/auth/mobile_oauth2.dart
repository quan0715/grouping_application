...
//     String stringUrl = EndPointGetter.getAuthBackendEndpoint('exchange_params'); // get url
...
// // class MobileOAuthService extends BaseOauth{
// //   MobileOAuthService({
...
// //   @override
// //   Future<void> showWindowAndListen(Function(UrlChange?)? onUrlChange) async{
// //     WebViewController controller = WebViewController()
// //       ..setJavaScriptMode(JavaScriptMode.unrestricted)
// //       ..setNavigationDelegate(
// //         NavigationDelegate(
